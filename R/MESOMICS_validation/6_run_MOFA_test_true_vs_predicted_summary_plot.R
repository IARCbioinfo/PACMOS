...
generate_LOO_test_sample_QC(
  ...
  global_reference = "/data/mesomics/work/mesomics2/lipikal/lipikal-2026/Rpackage/PACMOS/PACMOS/inst/extdata/MESOMICS_references/MESOMICS_latent_factors.csv",
  ...
  axis_rename = c(
    ...
    "Adaptive-response_LF" = "Adaptive response"
  ),
  axis_cols = c(
     "Morphology"        = "#B81330",
    "Adaptive response" =  "#79A960"
  )
)
