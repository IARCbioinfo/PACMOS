...
plot_alignment_QC_summary(
  aggregated_csv = "/data/mesomics/work/mesomics2/lipikal/lipikal-2026/Rpackage/PACMOS/PACMOS/Analysis_010426/Mesomics_LOO/all_samples_quality_check_metrics.csv",
  out_dir        = "/data/mesomics/work/mesomics2/lipikal/lipikal-2026/Rpackage/PACMOS/PACMOS/Analysis_010426/Mesomics_LOO/QC_summary",
  out_prefix     = "Mesomics_input_samples_new_ref_",
  axis_rename    = c(
    "Ploidy_LF"            = "Ploidy",
