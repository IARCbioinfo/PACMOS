...
s3_plot_all_samples_mofa(
  ...
  reference_LFs   = "/data/mesomics/work/mesomics2/lipikal/lipikal-2026/Rpackage/PACMOS/PACMOS/inst/extdata/MESOMICS_references/MESOMICS_latent_factors.csv",
  reference_axes  = c("Ploidy_LF", "Morphology_LF",
                      "Adaptive-response_LF", "CIMP-index_LF"),
