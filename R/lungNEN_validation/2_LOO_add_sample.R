...
run_add_sample_to_mofa_lungNEN_validation <- function(
    input_dirs,
    layers = "all",
...
input_dirs <- list.dirs(
  "/data/mesomics/work/mesomics2/lipikal/lipikal-2026/Rpackage/PACMOS/PACMOS/Analysis_010426/lungNEN_LOO",
  recursive = FALSE,
  full.names = TRUE
)

#change this for different omics combination
run_add_sample_to_mofa_lungNEN_validation(
